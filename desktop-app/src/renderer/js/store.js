  ...
  const defaults = {
    ...
    blocklist: {
      ...
      graylist: [
        ...
        { id: 'twitch', url: 'twitch.tv', kind: 'api', on: true, desc: 'Sexually-labelled streams, VODs & clips stripped; labelled channels, the hot-tub category & explicit searches blocked' },
        { id: 'kick', url: 'kick.com', kind: 'api', on: true, desc: 'Mature-flagged streams & clips stripped from browse and search; mature channels & explicit searches blocked' },
        ...
        { id: 'instagram', url: 'instagram.com', kind: 'enforce', on: true, desc: 'Explicit hashtag & search surfaces blocked; feed, profiles and DMs untouched' },
        { id: 'tiktok', url: 'tiktok.com', kind: 'enforce', on: true, desc: 'Explicit hashtag & search surfaces blocked; feed and profiles untouched' },
